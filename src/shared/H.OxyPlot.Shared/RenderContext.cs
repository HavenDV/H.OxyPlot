...
namespace OxyPlot.Windows
{
    ...
    public class RenderContext : IRenderContext
    {
        ...
        public void DrawText(
            ...
            double rotation = 0,
            OxyPlot.HorizontalAlignment horizontalAlignment = OxyPlot.HorizontalAlignment.Left,
            OxyPlot.VerticalAlignment verticalAlignment = OxyPlot.VerticalAlignment.Top,
            OxySize? maxSize = null)
        {
            ...
            double dx = 0;
            if (horizontalAlignment == OxyPlot.HorizontalAlignment.Center)
            {
                dx = -size.Width / 2;
            }

            if (horizontalAlignment == OxyPlot.HorizontalAlignment.Right)
            {
                dx = -size.Width;
            }

            double dy = 0;
            if (verticalAlignment == OxyPlot.VerticalAlignment.Middle)
            {
                dy = -size.Height / 2;
            }

            if (verticalAlignment == OxyPlot.VerticalAlignment.Bottom)
            {
                dy = -size.Height;
            }
            ...
            {
                transform.Children.Add(new RotateTransform { Angle = rotation });
            }
